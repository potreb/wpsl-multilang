...
class Widget extends \WP_Widget {
	 ...
	 * Widget constructor.
	 *
	 * @param Plugin   $plugin   Plugin reference.
	 * @param Frontend $frontend Plugin reference.
	 */
	public function __construct( Plugin $plugin, Frontend $frontend ) {
		$this->plugin   = $plugin;
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( in_array( $new_instance['list_type'], array( 'list_with_flags', 'list_without_flags', 'select' ), true ) ) {
